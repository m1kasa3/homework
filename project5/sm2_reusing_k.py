...
# 3. 对消息 M1 签名
message1 = "First message with reused k"
r1, s1, e1 = sign_sm2_algebraic(d_original, k_reused, message1)
print(f"\n签名1 (r1, s1): ({hex(r1)}, {hex(s1)})")

# 4. 对消息 M2 签名
message2 = "Second message with reused k"
r2, s2, e2 = sign_sm2_algebraic(d_original, k_reused, message2)
